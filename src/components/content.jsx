...
const ContentBox = props => {
  ...
  useEffect(() => {
    if (animate) {
      ...
      window.addEventListener(
        ...
        e => {
          if (
            window.pageYOffset > anOb.y - anOb.height &&
            window.pageYOffset < anOb.y + anOb.height
          ) {
            //                    console.log((window.pageYOffset - anOb.y + anOb.height) / (anOb.height * 2))
            tl.progress(
              (window.pageYOffset - anOb.y + anOb.height) / (anOb.height * 2)
            )
          }
        },
        { passive: true }
  ...
  return (
    <div ref={div => (animate = div)} className="contentBox">
      {props.children}
    </div>
  )
}
...
const Content = props => {
  ...
  return (
    <div className="scrollContainer">
      ...
      <ContentBox>
        <h1
        onMouseMove={() => handleEnter("#000000")}
          onMouseLeave={() => handleLeave()}
            >
          <a href = "https://www.benswansonralph.com" target = "_blank">BSR</a>
        </h1>
      ...
      <ContentBox>
        ...
        <h2>
          ...
          <span
            ...
            onClick={() => handleClick()}
          >
            will@willchatterson.com
          </span>
        </h2>
        <h2 style={{ visibility: "hidden" }} ref={div => (message = div)}>
